...
export class GameComponent implements OnInit {
  ...
  openModal() {
    ...
    const dialog = this.matDialog.open(ModalTestComponent, {
      data: {
        formTitle: 'Add'
      },
    },
    ...
    dialog.afterClosed().subscribe(
      data2 => {
        if (data2) {
          console.log("Add output:", data2);

          // const data2 = { title: 'Angular PUT Request Example' };

          // this.http.post<any>('https://jsonplaceholder.typicode.com/posts/1', data2)
  ...
  openModal2() {
    ...
    dialog.afterClosed().subscribe(
      data2 => {
        if (data2) {
          console.log("Edit output:", data2);

          // const data2 = { title: 'Angular PUT Request Example' };

          // this.http.put<any>('https://jsonplaceholder.typicode.com/posts/1', data2)
          //   .subscribe(data => this.postId = data.id);
        }
        else {
          console.log("cancel");
